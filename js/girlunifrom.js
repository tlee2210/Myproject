angular.module("myApp.girl",["ui.bootstrap"])
    .controller("girlCtrl", ["$scope","$filter", "productAPIservice","$routeParams", function($scope, $filter, productAPIservice, $routeParams){
