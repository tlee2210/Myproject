angular.module("myApp.boy",["ui.bootstrap"])
    .controller("boyCtrl", ["$scope","$filter", "productAPIservice","$routeParams", function($scope, $filter, productAPIservice, $routeParams){
